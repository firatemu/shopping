...
export class BranchController {
    ...
    async remove(@TenantId() tenantId: string, @Param('id') id: string) {
        await this.branchService.remove(tenantId, id);
    }
    ...
    async createTransfer(@TenantId() tenantId: string, @Body() dto: any, @CurrentUser('id') userId: string) {
    ...
    async receiveTransfer(@TenantId() tenantId: string, @Param('id') id: string, @Body('items') items: any, @CurrentUser('id') userId: string) {
    ...
    async listTransfers(@TenantId() tenantId: string, @Query('page') page?: number, @Query('limit') limit?: number, @Query('status') status?: string) {
