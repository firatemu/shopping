...
describe('Sales Flow (E2E)', () => {
    ...
    beforeAll(async () => {
        ...
        const tenant = await prisma.tenant.create({
            data: { name: 'E2E Test Store', code: 'E2E', settings: { currency: 'TRY', defaultKdvRate: 20 } },
        });
        tenantId = tenant.id;
        ...
        await prisma.user.create({
            data: {
                tenantId, email: 'e2e@test.com', username: 'e2eadmin',
                firstName: 'E2E', lastName: 'Admin', role: 'TENANT_ADMIN', passwordHash: hash,
            },
        });
    ...
    describe('Complete sales cycle', () => {
        ...
        it('1. should create a product', async () => {
            const res = await request(app.getHttpServer())
                ...
                .send({
                    name: 'E2E Test Tişört', brand: 'TestBrand', category: 'Üst Giyim',
                    subcategory: 'Tişört', gender: 'Unisex', costPrice: 50, salePrice: 100, kdvRate: 20,
                })
                .expect(201);
