    ...
    return (
        <div className="p-6 max-w-6xl space-y-4">
            ...
            <form onSubmit={submit} className="grid gap-4 lg:grid-cols-3">
                {error && (
                    <div className="lg:col-span-3 rounded-[10px] border border-destructive/30 bg-destructive/5 p-3">
                ...
                {/* Column 2 */}
                <div className="rounded-[10px] border border-border bg-card p-4 space-y-3">
                    <p className="text-[11px] font-medium uppercase tracking-wider text-muted-foreground">Vergi bilgileri</p>
                    <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-1">
                        <div className="space-y-1.5">
                ...
                {/* Column 3 */}
                <div className="rounded-[10px] border border-border bg-card p-4 space-y-3">
                    <p className="text-[11px] font-medium uppercase tracking-wider text-muted-foreground">Finans</p>
                    <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-1">
                        <div className="space-y-1.5">
